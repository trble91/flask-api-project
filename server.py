...
Song(song_name='SHAQ', artist_name='TRBLE', album='3:20-EP', irsc= 'QZDA51930843').save()
Song(song_name='FameMiss', artist_name='TRBLE', album='3:20-EP', irsc= 'QZDA51930842').save()
Song(song_name='Onto Something', artist_name='TRBLE', album='Onto Something-Single', irsc= 'QZMWW2053469').save()
...
Song(song_name='Go Tina', artist_name='TRBLE', album='Go Tina-Single', irsc= 'QZFYZ2008014').save()
