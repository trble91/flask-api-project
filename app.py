...
Song(song_name='Real Thing', artist_name='TRBLE', album='Social Studies', irsc= '').save()
Song(song_name='S X T (Space & Time)', artist_name='TRBLE', album='Social Studies', irsc= '').save()
Song(song_name='Gone Till November', artist_name='TRBLE', album='Social Studies', irsc= '').save()
Song(song_name='Rewind', artist_name='TRBLE', album='Social Studies', irsc= '').save()
Song(song_name='Prayer', artist_name='TRBLE', album='Social Studies', irsc= '').save()
Song(song_name='Go Tina', artist_name='TRBLE', album='Go Tina', irsc= '').save()
Song(song_name='Permanently Phakin\' Love', artist_name='TRBLE', album='The Lost Baker-EP', irsc= '').save()
Song(song_name='F U G I', artist_name='TRBLE', album='The Lost Baker-EP', irsc= '').save()
Song(song_name='Lil Secret', artist_name='TRBLE', album='The Lost Baker-EP', irsc= '').save()
Song(song_name='Untitled Changes', artist_name='TRBLE', album='The Lost Baker-EP', irsc= '').save()
Song(song_name='Karma', artist_name='TRBLE', album='The Lost Baker-EP', irsc= '').save()
Song(song_name='Check', artist_name='TRBLE', album='Check-Single', irsc= '').save()
Song(song_name='Dear Father', artist_name='TRBLE', album='Dear Father-Single', irsc= '').save()
